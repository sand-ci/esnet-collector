...
class RabbitMQConnect:
    ...
    def createConnection(self):
        ...
        self.params = pika.ConnectionParameters(host=self.rabbithost, virtual_host=self.vhost, credentials=credentials, heartbeat=600, blocked_connection_timeout=300)
